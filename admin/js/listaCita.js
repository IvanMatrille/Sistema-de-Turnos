    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            for (const i in datos) 
            {
                ...
                row +=  '<td>' + '<button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo">Modificar</button>'
...
function modificarCita(matricula)
{
